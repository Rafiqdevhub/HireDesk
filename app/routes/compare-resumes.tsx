        ...
        <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Find Best
              <span className="text-purple-400 block">Fit</span>
            </h1>
              ...
              <div className="relative p-8 sm:p-12 md:p-16">
                <div className="text-center mb-8 sm:mb-12">
                  ...
                  <p className="text-slate-400 text-lg sm:text-xl max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed">
                    We're building the ultimate candidate comparison tool.
                    Upload multiple resumes and see detailed comparisons with
                    smart ranking algorithms.
                  </p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
                  <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-1">
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                    <div className="relative p-4 sm:p-6">
                      <div className="flex items-center mb-4">
                        <div className="p-3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg mr-4">
                          <svg
                      ...
                      <p className="text-slate-400 text-sm sm:text-base">
                        Compare candidates visually with detailed profiles and
                        metrics.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-1">
                    ...
                    <div className="relative p-4 sm:p-6">
                      ...
                      <p className="text-slate-400 text-sm sm:text-base">
                        Advanced algorithms rank candidates based on your
                  ...
                  <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-1">
                    ...
                    <div className="relative p-4 sm:p-6">
                      ...
                      <p className="text-slate-400 text-sm sm:text-base">
                        Get AI-powered recommendations to help you make the best
                        hiring choice.
                      </p>
                    </div>
                  </div>
                ...
                <div className="text-center">
                  <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg">
                    <svg
